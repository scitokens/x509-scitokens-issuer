...
setuptools.setup(name="x509-scitokens-issuer",
                 ...
                 data_files=[('/etc/httpd/conf.d', ['configs/x509_scitokens_issuer.conf']),
                             ('/usr/local/share/x509-scitokens-issuer', ['configs/x509_scitokens_issuer.cfg']),
                             ('/usr/local/lib/systemd/system', ['configs/cms-mapping-updater.service', 'configs/cms-mapping-updater.timer']),
